...
const straightShots: Trophy = {
  ...
  attributes: ['participantStats.headshotKills', 'generalStats.mostHeadshotKills'],
  // https://game-icons.net/1x1/skoll/headshot.html
  svgPath:
  ...
  check: ({ participantStats, generalStats }) => {
